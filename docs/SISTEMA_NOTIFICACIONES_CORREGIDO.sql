-- =====================================================
-- SISTEMA COMPLETO DE NOTIFICACIONES - CORREGIDO
-- =====================================================
...
-- PASO 2: LIMPIAR TRIGGER Y FUNCIÓN EXISTENTES (CON CASCADE)
...
-- PASO 3: CREAR/ACTUALIZAR TABLA DE NOTIFICACIONES
...
-- PASO 6: VERIFICAR/ACTUALIZAR TABLA users_profiles
DO $$
BEGIN
...
-- PASO 7: CREAR FUNCIÓN DE TRIGGER OPTIMIZADA
...
-- PASO 9: FUNCIONES AUXILIARES PARA EL SISTEMA
...
-- PASO 10: CREAR FUNCIONES PARA TIPOS ESPECÍFICOS DE NOTIFICACIONES
...
-- PASO 11: VERIFICACIÓN FINAL DEL SISTEMA
SELECT 
...
-- PASO 12: INSERTAR NOTIFICACIÓN DE PRUEBA DEL SISTEMA COMPLETO
INSERT INTO notifications (
    user_id,
    title,
    message,
